      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div>
            ...
            <select name="paymentMethod" style={{ ...inputStyle, appearance: "none", cursor: "pointer" }}>
              {PAYMENT_METHODS.map((m) => (
                <option key={m} value={m} style={{ background: "#0f0f1a" }}>
          ...
          {error && (
            <p style={{
              ...
              borderRadius: "10px", padding: "12px 16px", margin: 0,
            }}>{error}</p>
          )}
